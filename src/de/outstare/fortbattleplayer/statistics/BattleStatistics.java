...
public class BattleStatistics implements DynamicStatistics, CombatantObserver {
    ...
    private final Map<Combatant, OnlineCounter> onliners = new java.util.LinkedHashMap<Combatant, OnlineCounter>();

    private final Map<CombatantSide, List<CriticalHit>> critHits = new org.apache.commons.collections4.map.HashedMap<CombatantSide, List<CriticalHit>>();
    ...
    private final Map<CombatantSide, Set<PositionSwitch>> swapList = new org.apache.commons.collections4.map.HashedMap<CombatantSide, Set<PositionSwitch>>();
    ...
    private final Map<CombatantSide, RoundStatistics> shotsPerRound = new org.apache.commons.collections4.map.HashedMap<CombatantSide, RoundStatistics>();
    ...
    private final Map<CombatantSide, RoundStatistics> hitsPerRound = new org.apache.commons.collections4.map.HashedMap<CombatantSide, RoundStatistics>();
    ...
    private final Map<CombatantSide, AtomicInteger> shotRoundCounter = new org.apache.commons.collections4.map.HashedMap<CombatantSide, AtomicInteger>();
    ...
    private final Map<CombatantSide, AtomicInteger> hitRoundCounter = new org.apache.commons.collections4.map.HashedMap<CombatantSide, AtomicInteger>();
    ...
    private final List<Combatant> turnOrder = new java.util.ArrayList<Combatant>();

    private final List<AllCombatantSidesCounter> actorsPerRound = new ArrayList<AllCombatantSidesCounter>(50);

    private final Map<Area, AreaStatistic> fieldStats = new java.util.LinkedHashMap<Area, AreaStatistic>();
