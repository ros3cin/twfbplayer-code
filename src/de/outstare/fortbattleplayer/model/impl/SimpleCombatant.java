...
public class SimpleCombatant implements Combatant {
     ...
     *             not null
     */
    public SimpleCombatant(final CombatantSide side, final CombatantState initialState, final int maxHealth, final String name, final CharacterClass characterClass, final int characterLevel, final Weapon weapon, final String city) {
